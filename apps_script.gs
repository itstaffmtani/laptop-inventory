...
const SHEET_ID = 'GANTI_DENGAN_ID_SPREADSHEET'; // ambil dari URL sheets
const SHEET_NAME = 'Data Laptop';

const HEADERS = [
  'Timestamp', 'Nama', 'Status Laptop',
  'Merk', 'Model', 'CPU', 'RAM', 'Storage',
  'Kerusakan', 'OS', 'Serial Number'
];
...
function doGet() {
  return ContentService
    .createTextOutput('MTani Laptop Inventory — Apps Script aktif ✓');
}
